    ...
    <div className="flex flex-col min-h-screen bg-[#030712] text-slate-200 selection:bg-accent/30 selection:text-white">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="relative mb-1 md:mb-4 animate-fade-in delay-100">
            <Image
              ...
              width={320}
              height={213}
              className="h-20 md:h-[88px] w-auto object-contain mx-auto drop-shadow-[0_0_25px_rgba(56,189,248,0.4)]"
              priority
      ...
      <section id="machines" className="relative z-10 px-4 md:px-6 py-3 md:py-10">
        <div className="max-w-6xl mx-auto">
          <div className="flex flex-row items-end justify-between mb-2 md:mb-6 gap-2 md:gap-4">
            <div>
              <h2 className="text-accent font-black uppercase tracking-[0.2em] text-[10px] md:text-xs mb-0.5 md:mb-2">The Armory</h2>
            ...
            <p className="text-slate-400 text-xs md:text-sm text-right max-w-[160px] md:max-w-sm leading-relaxed">From pro leather ball sessions to high-speed indoor tennis setups.</p>
          </div>
          ...
          <div className="grid grid-cols-2 lg:grid-cols-2 gap-2 md:gap-4">
            ...
            <div className="group relative glass rounded-xl md:rounded-2xl overflow-hidden border-white/5 hover:border-accent/30 transition-all duration-500 hover:shadow-2xl hover:shadow-accent/5">
              <div className="p-2 md:p-4">
                <div className="flex justify-between items-center mb-1.5 md:mb-2">
                  <h4 className="text-sm md:text-xl font-black text-white group-hover:text-accent transition-colors uppercase italic leading-none">Gravity</h4>
                  <span className="px-1.5 py-0.5 md:px-2.5 md:py-0.5 rounded-full bg-red-500/10 border border-red-500/20 text-red-500 text-[9px] md:text-xs font-black uppercase tracking-widest flex-shrink-0">Leather</span>
                </div>
                <div className="flex flex-wrap gap-1 md:gap-1.5">
                  {['Astro Turf', 'Cement', 'Natural Turf'].map(tag => (
                    <span key={tag} className="text-[9px] md:text-xs font-bold px-1.5 py-0.5 md:px-2 md:py-0.5 rounded bg-white/5 text-slate-400 border border-white/5 uppercase tracking-wider">{tag}</span>
                  ))}
                </div>
              </div>
              <div className="relative aspect-[4/3] bg-[#050b14] overflow-hidden border-t border-white/5">
                <Image
                  src="/images/leathermachine.jpeg"
                  alt="Gravity bowling machine"
                  fill
                  className="object-cover object-center group-hover:scale-105 transition-transform duration-1000 opacity-90 group-hover:opacity-100"
                  loading="lazy"
            ...
            <div className="group relative glass rounded-xl md:rounded-2xl overflow-hidden border-white/5 hover:border-amber-500/30 transition-all duration-500 hover:shadow-2xl hover:shadow-amber-500/5">
              <div className="p-2 md:p-4">
                <div className="flex justify-between items-center mb-1.5 md:mb-2">
                  <h4 className="text-sm md:text-xl font-black text-white group-hover:text-amber-500 transition-colors uppercase italic leading-none">Yantra</h4>
                  <span className="px-1.5 py-0.5 md:px-2.5 md:py-0.5 rounded-full bg-amber-500/10 border border-amber-500/20 text-amber-500 text-[9px] md:text-xs font-black uppercase tracking-widest flex-shrink-0">Premium Leather</span>
                </div>
                <div className="flex flex-wrap gap-1 md:gap-1.5">
                  {['Astro Turf', 'Cement', 'Natural Turf'].map(tag => (
                    <span key={tag} className="text-[9px] md:text-xs font-bold px-1.5 py-0.5 md:px-2 md:py-0.5 rounded bg-white/5 text-slate-400 border border-white/5 uppercase tracking-wider">{tag}</span>
              ...
              <div className="relative aspect-[4/3] bg-[#050b14] overflow-hidden border-t border-white/5">
                <Image
                  ...
                  fill
                  className="object-cover object-[center_40%] group-hover:scale-105 transition-transform duration-1000 opacity-90 group-hover:opacity-100"
                  loading="lazy"
                  sizes="(max-width: 768px) 50vw, 600px"
                />
              </div>
            ...
            <div className="group relative glass rounded-xl md:rounded-2xl overflow-hidden border-white/5 hover:border-green-500/30 transition-all duration-500 hover:shadow-2xl hover:shadow-green-500/5">
              <div className="p-2 md:p-4">
                <div className="flex justify-between items-center mb-1.5 md:mb-2">
                  <h4 className="text-[11px] md:text-lg font-black text-white group-hover:text-green-500 transition-colors uppercase italic leading-none">Leverage High Speed Tennis</h4>
                  <span className="px-1.5 py-0.5 md:px-2.5 md:py-0.5 rounded-full bg-green-500/10 border border-green-500/20 text-green-500 text-[9px] md:text-xs font-black uppercase tracking-widest flex-shrink-0 ml-1.5">Indoor</span>
                </div>
                <div className="flex flex-wrap gap-1 md:gap-1.5">
                  {['Astro Turf', 'Cement', 'Natural Turf'].map(tag => (
                    <span key={tag} className="text-[9px] md:text-xs font-bold px-1.5 py-0.5 md:px-2 md:py-0.5 rounded bg-white/5 text-slate-400 border border-white/5 uppercase tracking-wider">{tag}</span>
              ...
              <div className="relative aspect-[4/3] bg-[#050b14] overflow-hidden border-t border-white/5">
                <Image
                  ...
                  fill
                  className="object-cover object-[center_25%] group-hover:scale-105 transition-transform duration-1000 opacity-90 group-hover:opacity-100"
                  loading="lazy"
                  sizes="(max-width: 768px) 50vw, 600px"
                />
              </div>
            ...
            <div className="group relative glass rounded-xl md:rounded-2xl overflow-hidden border-white/5 hover:border-emerald-500/30 transition-all duration-500 hover:shadow-2xl hover:shadow-emerald-500/5">
              <div className="p-2 md:p-4">
                <div className="flex justify-between items-center mb-1.5 md:mb-2">
                  <h4 className="text-[11px] md:text-lg font-black text-white group-hover:text-emerald-500 transition-colors uppercase italic leading-none">Leverage High Speed Tennis</h4>
                  <span className="px-1.5 py-0.5 md:px-2.5 md:py-0.5 rounded-full bg-emerald-500/10 border border-emerald-500/20 text-emerald-500 text-[9px] md:text-xs font-black uppercase tracking-widest flex-shrink-0 ml-1.5">Outdoor</span>
                </div>
                <div className="flex flex-wrap gap-1 md:gap-1.5">
                  {['Astro Turf', 'Cement', 'Natural Turf'].map(tag => (
                    <span key={tag} className="text-[9px] md:text-xs font-bold px-1.5 py-0.5 md:px-2 md:py-0.5 rounded bg-white/5 text-slate-400 border border-white/5 uppercase tracking-wider">{tag}</span>
            ...
            {[
              ...
              return (
                <div key={i} className="group glass-dark p-2 md:p-4 rounded-lg md:rounded-2xl border-white/5 hover:border-white/10 hover:bg-white/[0.04] transition-all text-center md:text-left">
                  ...
                  <p className="text-slate-400 text-[10px] md:text-xs leading-relaxed group-hover:text-slate-300 transition-colors">{feature.desc}</p>
                </div>
              );
            })}
          </div>
      ...
      <section className="relative z-10 px-4 md:px-6 py-3 md:py-10 overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto glass rounded-xl md:rounded-2xl p-3 md:p-6 text-center border-white/10">
          ...
          <p className="text-slate-400 text-xs md:text-sm mb-3 md:mb-6 max-w-xl mx-auto leading-relaxed">Reach out via phone or Social Media.</p>
          ...
          <div className="flex flex-row items-start justify-center gap-4 md:gap-6">
            <a href="tel:7058683664" className="flex flex-col items-center gap-0.5 md:gap-1 group active:scale-95 transition-transform">
              ...
              <span className="text-[10px] md:text-xs uppercase font-black tracking-widest text-slate-500">Pratyush</span>
              <span className="text-white font-bold text-xs md:text-sm">7058683664</span>
            </a>
            ...
            <a href="tel:7774077995" className="flex flex-col items-center gap-0.5 md:gap-1 group active:scale-95 transition-transform">
              ...
              <span className="text-[10px] md:text-xs uppercase font-black tracking-widest text-slate-500">Rahul</span>
              <span className="text-white font-bold text-xs md:text-sm">7774077995</span>
            </a>
            <div className="hidden md:block w-px h-16 bg-white/10"></div>
            <a href="tel:9975011081" className="flex flex-col items-center gap-0.5 md:gap-1 group active:scale-95 transition-transform">
              ...
              <span className="text-[10px] md:text-xs uppercase font-black tracking-widest text-slate-500">Raj</span>
              <span className="text-white font-bold text-xs md:text-sm">9975011081</span>
            </a>
            <div className="hidden md:block w-px h-16 bg-white/10"></div>
            <a
            ...
            >
              ...
              <span className="text-[10px] md:text-xs uppercase font-black tracking-widest text-slate-500">Instagram</span>
              <span className="text-white font-bold text-xs md:text-sm">@playorbit.in</span>
            </a>
          </div>
        </div>
      </section>
      ...
      {/* Footer */}
      <footer className="relative z-10 py-3 md:py-4 px-4 md:px-6 border-t border-white/5 glass-dark">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-3 md:gap-4">
          <div className="flex items-center gap-2">
            <Image
              ...
              width={160}
              height={107}
              className="h-12 md:h-24 w-auto object-contain opacity-80"
              loading="lazy"
              sizes="(max-width: 768px) 60px, 120px"
            />
          ...
          <div className="flex items-center gap-6 md:gap-6">
            <button onClick={openLogin} className="text-xs md:text-sm font-bold uppercase tracking-wider text-slate-400 hover:text-accent transition-colors py-3 min-h-[44px] flex items-center cursor-pointer">Book Now</button>
            <button onClick={openLogin} className="text-xs md:text-sm font-bold uppercase tracking-wider text-slate-400 hover:text-accent transition-colors py-3 min-h-[44px] flex items-center cursor-pointer">Admin</button>
            <a href="#" className="text-xs md:text-sm font-bold uppercase tracking-wider text-slate-400 hover:text-accent transition-colors py-3 min-h-[44px] flex items-center">Support</a>
          </div>

          <div className="text-center md:text-right">
            <p className="text-[10px] md:text-xs font-black uppercase tracking-[0.2em] text-slate-600 leading-none">&copy; {new Date().getFullYear()} PlayOrbit. Designed for Champions.</p>
          </div>
        </div>
